...
# Hairbrain
An application that allows hairstylists to keep track of their clients in an 
...
## History
Version 0.1 - Initial Beta of Application. 

## Credits
Author: Robert Charles Hay - haytherecharlie

## License
Hairbrain - Terms and conditions

Preamble: This Agreement, signed on Jan 14, 2017 (hereinafter: Effective Date) governs the relationship between Robert Charles Hay, a Business Entity, (hereinafter: Licensee) and Hairbrain, a private person whose principal place of business is 803 Talbot Street (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Hairbrain (hereinafter: The Software) created and owned by Licensor, as detailed herein
